...
import { BaseAgentRuntime } from '@telegraph/agent/runtime/AgentRuntime';
/**
    ...
    async *run(input) {
        ...
        try {
            ...
            for await (const ev of streamPiAiRuntimeEvents({
                runId,
                settings: settings, // TODO: type alignment between RuntimeSettings and AgentRuntimeSettings
                message,
                signal,
            })) {
                yield ev;
