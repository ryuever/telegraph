...
import { createMiniMaxOpenAIModel, MINIMAX_OPENAI_BASE_URL, } from '@telegraph/agent/providers/minimax';
...
export function resolveModel(settings) {
    ...
    return getModel(settings.provider, settings.modelId);
}
export { createMiniMaxOpenAIModel, MINIMAX_OPENAI_BASE_URL, };
