...
| P-010 | [20260522-remote-agent-os-implementation-roadmap.md](./roadmap/20260522-remote-agent-os-implementation-roadmap.md) | Remote Agent OS 能力象限与实施路线图 | 基于 A-013 的 Remote Agent OS 目标架构，定义 CLI、Mobile、Telegram、Slack、MCP、Computer Use、Relay 与 Sandbox 的能力取舍、技术象限、分阶段实施路径、验收标准和风险控制。 |
