...
- `extensions/telegraph-subagents/src/TelegraphSubagentHarness.ts`
- `packages/agent/src/runtime/streamPiAiRuntime.ts`
- `extensions/telegraph-subagents/src/__tests__/TelegraphSubagentHarness.test.ts`
...
```bash
pnpm --filter @telegraph/extension-telegraph-subagents exec vitest run src/__tests__/TelegraphSubagentHarness.test.ts
# passed
