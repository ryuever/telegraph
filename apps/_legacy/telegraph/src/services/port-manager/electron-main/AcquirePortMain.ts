...
import { sharedProcessName } from '@telegraph/services/process/shared-process/common/config'
import { daemonProcessName } from '@telegraph/services/process/daemon-process/common/config'
