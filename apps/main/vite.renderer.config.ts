...
export default defineConfig(({ command }) => ({
  ...
  resolve: {
    alias: {
      ...
      'node:util': resolve(__dirname, 'src/application/browser/sandpacker-node-stubs/util.ts'),
      ...
      tty: 'tty-browserify',
      url: 'url',
      util: resolve(__dirname, 'src/application/browser/sandpacker-node-stubs/util.ts'),
      vm: 'vm-browserify',
