...
import { PanelFactoryId } from '@app/services/tabs/electron-main/Panel'
import type { IPanelFactory } from '@app/services/tabs/electron-main/Panel'
import { DisposablePanelFactoryId } from '@app/services/tabs/electron-main/DisposablePanel'
import type { IDisposablePanelFactory } from '@app/services/tabs/electron-main/DisposablePanel'
...
import type { PanelStack, CreatePanelProps } from '@app/services/window-manager/common/types'
import type { Workbench } from '@app/services/workbench/electron-main/Workbench'
import type Pagelet from '@app/services/tabs/electron-main/Pagelet'
...
import { BaseWindowLog } from '@app/services/log/common/constants'
